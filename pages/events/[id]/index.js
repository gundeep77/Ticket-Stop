    ...
    const buildPreSale = (event) => {
      return (
        <Typography component="span" key={event.name}>
          <dt className="title">
            {event.name ? event.name : <span>N.A</span>}:
          </dt>
          {event ? (
            <dd className="preSaleName">
              {splitByT(event.startDateTime)} - {splitByT(event.endDateTime)}
              <br />
            </dd>
          ) : (
            <span>N.A</span>
          ...
          <CardContent>
            <Typography component="span" variant="h6">
              <dl>
                ...
                {data.dates.start && data.dates.start.localDate ? (
                  <dd>{convertDate(data.dates.start.localDate)}</dd>
                ) : (
                  <span>N.A</span>
                )}
                <br />
                <dt className="title">Stat Time:</dt>
                {data.dates.start && data.dates.start.localTime ? (
                  <dd>{convertTime(data.dates.start.localTime)}</dd>
                ) : (
                  <span>N.A</span>
                )}
                <br />
                ...
                data.priceRanges[0].max ? (
                  <dd>
                    ${data.priceRanges[0].min.toString()} - $
                    {data.priceRanges[0].max.toString()}
                  </dd>
                ) : (
                  <span>N.A</span>
                )}
                <br />
                <br />
                <dt className="title">Pre-Sales</dt>
                <br />
                {block}
                <br />
                ...
                data.sales.public.endDateTime ? (
                  <dd>
                    {splitByT(data.sales.public.startDateTime)} -{" "}
                    {splitByT(data.sales.public.endDateTime)}
                  </dd>
                ) : (
                  <span>N.A</span>
                )}
                ...
                data._embedded.attractions[0].upcomingEvents &&
                data._embedded.attractions[0].upcomingEvents._total ? (
                  <dd>
                    {data._embedded.attractions[0].upcomingEvents._total} events
                  </dd>
                ) : (
                  <span>N.A</span>
                )}
                ...
                <br></br>
                {data._embedded.attractions &&
                data._embedded.attractions[0].externalLinks &&
                (data._embedded.attractions[0].externalLinks.youtube ||
                  data._embedded.attractions[0].externalLinks.twitter ||
                  data._embedded.attractions[0].externalLinks.facebook ||
                  data._embedded.attractions[0].externalLinks.instagram ||
                  data._embedded.attractions[0].externalLinks.itunes ||
                  data._embedded.attractions[0].externalLinks.lastfm ||
                  data._embedded.attractions[0].externalLinks.spotify) ? (
                  <p>Use below links to follow on social media</p>
                ) : (
                  <span></span>
                )}
              </dl>
              ...
              data._embedded.attractions[0].externalLinks.youtube ? (
                <div className="child">
                  <Link
                    ...
                    target="_blank"
                    href={
                      data._embedded.attractions[0].externalLinks.youtube[0].url
                    }
                  >
                    <Image
                      className="icon"
              ...
              data._embedded.attractions[0].externalLinks.twitter ? (
                <div className="child">
                  <Link
                    ...
                    target="_blank"
                    href={
                      data._embedded.attractions[0].externalLinks.twitter[0].url
                    }
                  >
                    <Image
                      className="icon"
              ...
              data._embedded.attractions[0].externalLinks.facebook ? (
                <div className="child">
                  <Link
                    ...
                    target="_blank"
                    href={
                      data._embedded.attractions[0].externalLinks.facebook[0]
                        .url
                    }
                  >
                    <Image
              ...
              data._embedded.attractions[0].externalLinks.instagram ? (
                <div className="child">
                  <Link
                    ...
                    target="_blank"
                    href={
                      data._embedded.attractions[0].externalLinks.instagram[0]
                        .url
                    }
                  >
                    <Image
              ...
              data._embedded.attractions[0].externalLinks.itunes ? (
                <div className="child">
                  <Link
                    ...
                    target="_blank"
                    href={
                      data._embedded.attractions[0].externalLinks.itunes[0].url
                    }
                  >
                    <Image
                      className="icon"
              ...
              data._embedded.attractions[0].externalLinks.lastfm ? (
                <div className="child">
                  <Link
                    ...
                    target="_blank"
                    href={
                      data._embedded.attractions[0].externalLinks.lastfm[0].url
                    }
                  >
                    <Image
                      className="icon"
            ...
            <br></br>
            <Typography>
              <Link href={"/events/page/1"} className="link">
                Back to all Events
              </Link>
            </Typography>
          </CardContent>
...
async function getEventData(id) {
  try {
    const { data } = await axios.get(
      `https://app.ticketmaster.com/discovery/v2/events?apikey=7ShMgZO4XCXJNbGkkI47LMDD9GDGXrpG&id=${id}`
    );
    if (data._embedded) {
