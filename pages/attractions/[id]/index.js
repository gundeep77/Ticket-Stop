        ...
        <Card className="card" variant="outlined">
          ...
          <CardContent>
            ...
            <div className="parent">
              {data.externalLinks && data.externalLinks.youtube ? (
                <div className="child">
                  <Link
                    rel="noopener noreferrer"
                    target="_blank"
              ...
              {data.externalLinks && data.externalLinks.twitter ? (
                <div className="child">
                  <Link
                    rel="noopener noreferrer"
                    target="_blank"
              ...
              {data.externalLinks && data.externalLinks.facebook ? (
                <div className="child">
                  <Link
                    rel="noopener noreferrer"
                    target="_blank"
              ...
              {data.externalLinks && data.externalLinks.instagram ? (
                <div className="child">
                  <Link
                    rel="noopener noreferrer"
                    target="_blank"
              ...
              {data.externalLinks && data.externalLinks.itunes ? (
                <div className="child">
                  <Link
                    rel="noopener noreferrer"
                    target="_blank"
              ...
              {data.externalLinks && data.externalLinks.lastfm ? (
                <div className="child">
                  <Link
                    rel="noopener noreferrer"
                    target="_blank"
              ...
              {data.externalLinks && data.externalLinks.spotify ? (
                <div className="child">
                  <Link
                    rel="noopener noreferrer"
                    target="_blank"
            ...
            <br></br>
            <Typography>
              <Link href={"/attractions/page/1"} className="link">
...
async function getEventData(id) {
  try {
    const { data } = await axios.get(
      `https://app.ticketmaster.com/discovery/v2/attractions?apikey=7ShMgZO4XCXJNbGkkI47LMDD9GDGXrpG&id=${id}`
    );
    if (data._embedded) {
